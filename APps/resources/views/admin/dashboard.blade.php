    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-body">
                ...
                <div class="stat-desc">Revenue to date</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-body">
                ...
                <div class="stat-desc">Awaiting fulfillment</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-body">
                ...
                <div class="stat-number">{{ number_format($completedOrders) }}</div>
                <div class="stat-desc">Fulfilled orders</div>
            </div>
        </div>
    </div>
